...
# Branch Strategy
DEVELOPMENT_BRANCH="main"               # Simple strategy: all on main
STAGING_BRANCH="main"                   # Simple strategy: all on main
PRODUCTION_BRANCH="main"               # Simple strategy: all on main

# Release
PACKAGE_JSON_PATHS=""                    # Space-separated manifest paths
CHANGELOG_FILE=""                        # e.g., CHANGELOG.md
TAG_PREFIX="v"                           # e.g., v
GITHUB_REPO_URL="https://github.com/dnviti/cloudflare-warp-gnome-plugin"
